...
with sync_playwright() as p:
    ...
    page.goto("https://www.sampension.dk/om-sampension/ansvarlighed/ansvarlige-investeringer/aabenhed-paa-esg-omraadet/")
...
tabs = []
rd = []
tablepattern = re.compile(r"([A-Z0-9\-\&\.\s',]+?)\s+([\d\.]+)\s+([A-Z]{2}[A-Z0-9]{8,})")
...
neworder = ['Company', 'Ticker', 'ISIN', 'CUSIP', 'Shareholder', 'Other Shareholders', 'Stake', 'Report Date', 'Filing Date', 'PDF link']
